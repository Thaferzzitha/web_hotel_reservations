...
<html>
    ...
    <body class="bg-gray-200">
        <div class="bg-white p-6 rounded-lg shadow-md grid grid-cols-12">
            <h1 class="text-2xl font-medium col-span-11">Sistema de Reservación del Hotel El Cisne: Lista de Paquetes</h1>
        ...
        <div class="w-full h-full flex items-center justify-center mt-5">
            <div class="px-4 py-2 w-full mx-10 rounded-lg shadow-md flex bg-white">
                <a href = "${pageContext.request.contextPath}/admin/pack?action=create"
        ...
        <div class="w-full h-full flex items-center justify-center mt-5">
            ...
            <div class="px-4 py-2 w-full mx-10 rounded-lg shadow-md flex bg-white">
                <table class="table-fixed text-center mx-auto divide-y divide-gray-400"
                    ...
                    <thead>
                        <tr>
                            <th class="px-9 py-2">Nombre del Paquete</th>
                            <th class="px-9 py-2">Descuento</th>
                    ...
                    <tbody class=" divide-y divide-gray-300">
                        <c:forEach items="${packList}" var="pack">
                            <tr>
                                <td class="px-9 py-5">${pack.name}</td>
                                <td class="px-9 py-5">${pack.discount}%</td>
                                <td class="px-9 py-5">
                                    <a href = "${pageContext.request.contextPath}/admin/pack?action=show&packId=${pack.packId}"
                                       class="bg-indigo-500 hover:bg-indigo-700 text-white py-1 px-2 mx-2 rounded-lg"
                                       >Ver Servicios</a> 
                                    <a href = "${pageContext.request.contextPath}/admin/pack?action=edit&packId=${pack.packId}"
                                       class="bg-yellow-500 hover:bg-yellow-700 text-white py-1 px-2 mx-2 rounded-lg"
                                       >Editar</a> 
                                    <a href = "${pageContext.request.contextPath}/admin/pack?action=delete&packId=${pack.packId}"
