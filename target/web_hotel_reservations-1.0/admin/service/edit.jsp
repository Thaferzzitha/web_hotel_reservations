...
<html>
    ...
    <body class="bg-gray-200">
        <div class="bg-white p-6 rounded-lg shadow-md grid grid-cols-12">
            <h1 class="text-2xl font-medium col-span-11">Sistema de Reservación del Hotel El Cisne: Editar Servicio</h1>
        ...
        <div class="bg-gray-200 flex justify-center items-center  my-5">
            <form class="w-3/4 border border-blue-200 rounded bg-white p-5"
                ...
                <input
                        ...
                        >
                <div class="mb-4">
                    <label class="block text-gray-700 font-medium mb-2" for="serviceName">
                        Nombre *
                    </label>
                    <input
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 font-medium mb-2" for="servicePrice">
                        Precio *
                    </label>
                    <input
                        class="bg-gray-200 border border-gray-400 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:bg-white"
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 font-medium mb-2" for="payByPerson">
                    ...
                    <input
                        ...
                        name="payByPerson"
                        value = "true"
                        ${service.payByPerson == true ? "checked" : ""}
                        >
                </div>
                
                <div class="mb-4">
                    <label class="block text-gray-700 font-medium mb-2" for="payByDay">
                        ¿Se cobra por Día? *
                    </label>
                    <input
                        class="bg-gray-200 border border-gray-400 rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:bg-white"
