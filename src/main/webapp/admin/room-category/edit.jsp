...
<html>
    ...
    <body class="bg-gray-200">
        <div class="bg-white p-6 rounded-lg shadow-md grid grid-cols-12">
            <h1 class="text-2xl font-medium col-span-11">Sistema de Reservación del Hotel El Cisne: Editar Categoría de Cuarto</h1>
            ...
            <nav class="flex items-center justify-between flex-wrap bg-gray-900 p-6">
                <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    <div class="text-sm lg:flex-grow">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/room-categories" class="block mt-4 lg:inline-block lg:mt-0 text-gray-300 hover:text-white mr-4">
        ...
        <div class="bg-gray-200 flex justify-center items-center h-screen my-3">
            <form class="w-3/4 border border-blue-200 rounded bg-white p-5"
                  action = "${pageContext.request.contextPath}/admin/room-category"
                  method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="categoryName"
                        name="categoryName"
                        value="${roomCategory.categoryName}"
                        >
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <textarea class="bg-gray-200 border border-gray-400 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:bg-white"
                            ...
                            rows="4" 
                            cols="50">${roomCategory.categoryDescription}</textarea>                            
                    </div>
                </div>
                <div class="mb-4">
