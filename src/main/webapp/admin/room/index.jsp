...
<html>
    ...
    <body class="bg-gray-200">
        <div class="bg-white p-6 rounded-lg shadow-md grid grid-cols-12">
            <h1 class="text-2xl font-medium col-span-11">Sistema de Reservación del Hotel El Cisne: Lista de Cuartos</h1>
                    ...
                    <tbody class=" divide-y divide-gray-300">
                        <c:forEach items="${roomList}" var="room">
                            <tr>
                                ...
                                <td class="px-9 py-5">
                                    <a href = "${pageContext.request.contextPath}/room?action=show&roomId=${room.roomId}"
                                       class="bg-indigo-500 hover:bg-indigo-700 text-white py-1 px-2 mx-2 rounded-lg"
                                       >Ver</a> 
                                    <a href = "${pageContext.request.contextPath}/room?action=edit&roomId=${room.roomId}"
                                       class="bg-yellow-500 hover:bg-yellow-700 text-white py-1 px-2 mx-2 rounded-lg"
                                       >Editar</a> 
                                    <a href = "${pageContext.request.contextPath}/room?action=delete&roomId=${room.roomId}"
